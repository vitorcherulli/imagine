...
export async function buildDuplicateStoryBlock(input: {
  ...
  return {
    ...
    keyframeUrl,
    keyframeAiModel: keyframeUrl ? source.keyframeAiModel ?? null : null,
    videoUrl,
    videoAiModel: videoUrl ? source.videoAiModel ?? null : null,
    videoJobId: null,
    videoPollingUrl: null,
    audioUrl,
    narrationAiModel: audioUrl ? source.narrationAiModel ?? null : null,
    audioVolume: source.audioVolume,
    sceneAudioUrl,
    sceneAudioAiModel: sceneAudioUrl ? source.sceneAudioAiModel ?? null : null,
    ...
    videoCameraAngle: source.videoCameraAngle ?? "auto",
